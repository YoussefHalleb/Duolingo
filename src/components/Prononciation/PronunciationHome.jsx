    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        <div className="text-center mb-12 slide-down">
          <div className="welcome-banner p-8 mb-8 bg-gradient-to-r from-green-200 via-green-100 to-green-50 rounded-2xl shadow-lg transform hover:scale-102 transition-all duration-500">
            <div className="flex flex-col items-center space-y-6">
              <div className="welcome-icon w-16 h-16 bg-gradient-to-r from-green-600 to-green-500 rounded-full flex items-center justify-center animate-float">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h2 className="text-3xl font-bold text-emerald-700 mb-2 animate-fade-in">Welcome to Your Pronunciation Journey! 👋</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl mx-auto">
                <div className="feature-card p-4 bg-green-100/90 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 animate-slide-up hover:bg-green-200/90" style={{ animationDelay: '0.2s' }}>
                  <div className="text-green-600 mb-2">🎯</div>
                  <h3 className="text-lg font-semibold text-green-800 mb-2">Perfect Your Accent</h3>
                  <p className="text-green-700 text-sm">Master native-like pronunciation with our interactive tools</p>
                </div>
                <div className="feature-card p-4 bg-green-100/90 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 animate-slide-up hover:bg-green-200/90" style={{ animationDelay: '0.4s' }}>
                  <div className="text-green-600 mb-2">🔊</div>
                  <h3 className="text-lg font-semibold text-green-800 mb-2">Real-time Feedback</h3>
                  <p className="text-green-700 text-sm">Get instant feedback on your pronunciation accuracy</p>
                </div>
                <div className="feature-card p-4 bg-green-100/90 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 animate-slide-up hover:bg-green-200/90" style={{ animationDelay: '0.6s' }}>
                  <div className="text-green-600 mb-2">📈</div>
                  <h3 className="text-lg font-semibold text-green-800 mb-2">Track Progress</h3>
                  <p className="text-green-700 text-sm">Monitor your improvement with detailed statistics</p>
                </div>
              </div>
            </div>
                      </div>
        ...
        <div className="bg-green-100/90 backdrop-blur-sm rounded-2xl shadow-lg p-8 mb-12 slide-up">
